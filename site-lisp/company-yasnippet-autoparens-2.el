;;; company-yasnippet-autoparens-2.el --- company-mode completion backend for Yasnippet (Auto-parenthesis Extension)
...
(defun company-yasnippet-autoparens-2--candidates (prefix rest-args)
...
;;;###autoload
(defun company-yasnippet-autoparens-2 (command &optional arg &rest ignore)
...
"
  ...
  (cl-case command
    (interactive (company-begin-backend 'company-yasnippet-autoparens-2))
    (prefix
     ...
     (let ((annotation (get-text-property 0 'yas-annotation arg)))
       (when annotation
         (concat
          ...
          annotation))))
    (candidates (company-yasnippet-autoparens-2--candidates arg ignore))
    (no-cache t)
    (post-completion
...
;;; company-yasnippet-autoparens-2.el ends here
